              ...
              >
                <CardHeader className="flex flex-row items-center justify-between pb-0.5 p-1.5 space-y-0">
                  ...
                  <CardIcon variant={variant} className="w-6 h-6" aria-hidden="true">
                    {index === 0 && <Boxes className="h-3.5 w-3.5" />}
                    {index === 1 && <PackageCheck className="h-3.5 w-3.5" />}
                    {index === 2 && <AlertTriangle className="h-3.5 w-3.5" />}
                    {index === 3 && <TrendingDown className="h-3.5 w-3.5" />}
                  </CardIcon>
                </CardHeader>
