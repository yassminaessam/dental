    ...
    <ProtectedRoute>
      <DashboardLayout>
        <main className="flex w-full flex-1 flex-col gap-6 p-4 sm:gap-8 sm:p-6 lg:p-8 max-w-screen-2xl mx-auto overflow-x-hidden relative">
          ...
          <div className="grid gap-1.5 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="pt-0 p-1.5">
                    ...
                    <p className="text-[10px] text-gray-600 dark:text-gray-400 font-medium leading-tight">{stat.description}</p>
                  </CardContent>
                </Card>
              );
            })}
