                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Textarea id="address" placeholder={t('patient_pages.profile.address_placeholder')} rows={3} />
                    </div>
                  </div>
                  <Button 
                    className="mt-4"
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="emergencyName" placeholder={t('patient_pages.profile.contact_name_placeholder')} />
                    </div>
                    <div>
                      <Label htmlFor="emergencyRelation">{t('patient_pages.profile.relationship')}</Label>
                      <Input id="emergencyRelation" placeholder={t('patient_pages.profile.relationship_placeholder')} />
                    </div>
                    <div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="insuranceProvider" placeholder={t('patient_pages.profile.provider_placeholder')} />
                    </div>
                    <div>
                      <Label htmlFor="policyNumber">{t('patient_pages.profile.policy_number')}</Label>
                      <Input id="policyNumber" placeholder={t('patient_pages.profile.policy_placeholder')} />
                    </div>
                    <div>
                      <Label htmlFor="groupNumber">{t('patient_pages.profile.group_number')}</Label>
                      <Input id="groupNumber" placeholder={t('patient_pages.profile.group_placeholder')} />
                    </div>
                    <div>
                      <Label htmlFor="policyHolder">{t('patient_pages.profile.policy_holder')}</Label>
                      <Input id="policyHolder" placeholder={t('patient_pages.profile.holder_placeholder')} />
                    </div>
                  </div>
                  <Button 
                    className="mt-4"
