              ...
              >
                <CardHeader className="flex flex-row items-center justify-between pb-0.5 p-1.5 space-y-0">
                  ...
                  <CardIcon 
                    ...
                    aria-hidden="true"
                  >
                    {index === 0 && <BookOpen className="h-3.5 w-3.5" />}
                    {index === 1 && <HelpCircle className="h-3.5 w-3.5" />}
                    {index === 2 && <Users className="h-3.5 w-3.5" />}
                    {index === 3 && <HeadphonesIcon className="h-3.5 w-3.5" />}
                  </CardIcon>
                </CardHeader>
